...
{
	_delay_ms(40);   
	CLCD_voidWriteCmd(0b00111000);  //0x38 function set : 8bit 2line 5*7 Dot
	CLCD_voidWriteCmd(0b00001100);  //0x0c Display on Cursor off
	CLCD_voidWriteCmd(0b00000001);  //0x01 clear Display screen
	_delay_ms(2);
